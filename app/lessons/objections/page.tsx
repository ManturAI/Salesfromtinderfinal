    ...
    <div className="relative z-10 mx-auto max-w-2xl px-4 py-10">
        ...
        <button
          ...
          className={`px-4 py-2 text-sm rounded-full transition ${
            activeSection === "sprint"
              ? "bg-gradient-to-r from-violet-500/30 to-fuchsia-500/30 text_white border border-white/15"
      ...
      <div className="mt-8">
        {activeSection === "sprint" ? (
          <div className="space-y-4">
            <div className="group w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок: Работа с возражениями</span>
                <span className="block text-sm text-white/70">Стратегии и практики</span>
              </span>
            </div>

            {[
              { id: "case-obj-1", title: "Кейс: Цена слишком высокая", desc: "Разбор возражения" },
              { id: "tools-obj-1", title: "Инструменты: Карта возражений", desc: "Шаблоны ответов" },
            ].map((item) => (
          ...
          <div className="space-y-4">
            <div className="group w_full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/15 bg-gradient-to-br from-white/10 to-white/5 text-white/90 group-hover:text-fuchsia-300 transition-colors">
                <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок (архив): Типовые возражения</span>
                <span className="block text-sm text-white/70">Материалы прошлых спринтов</span>
              </span>
            </div>

            {[
              { id: "2024-06-obj", title: "Июнь 2024: Работа с ценой", desc: "Архивный урок" },
              { id: "2024-03-obj", title: "Март 2024: Отложенные решения", desc: "Архивный урок" },
            ].map((item) => (
