...
function PageContent() {
  ...
  return (
    <div className="relative z-10 mx-auto max-w-2xl px-4 py-10">
      ...
      <h1 className="text-2xl md:text-3xl font-bold">Закрытие сделки</h1>
        ...
        {activeSection === "sprint" ? (
          <div className="space-y-4">
            <div className="group w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок: Техника закрытия сделки</span>
                <span className="block text-sm text-white/70">Сценарии и практики коммуникации</span>
              </span>
            </div>

            {[
              { id: "case-1", title: "Кейс: финальный звонок", desc: "Разбор сценария" },
              { id: "tools-1", title: "Инструменты: чек-лист закрытия", desc: "Контроль шагов" },
            ].map((item) => (
          ...
          <div className="space-y-4">
            <div className="group w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок (архив): Работа с дедлайнами</span>
                <span className="block text-sm text-white/70">Материалы прошлых спринтов</span>
              </span>
            </div>

            {[
              { id: "2024-07", title: "Июль 2024: Условия и дедлайны", desc: "Архивный урок" },
              { id: "2024-05", title: "Май 2024: Финальные вопросы", desc: "Архивный урок" },
            ].map((item) => (
