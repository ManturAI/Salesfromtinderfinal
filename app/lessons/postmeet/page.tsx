...
function PageContent() {
  ...
  return (
    <div className="relative z-10 mx-auto max-w-2xl px-4 py-10">
      ...
      <h1 className="text-2xl md:text-3xl font-bold">После встречи</h1>
        ...
        {activeSection === "sprint" ? (
          <div className="space-y-4">
            <div className="group w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок: Follow-up после встречи</span>
                <span className="block text-sm text-white/70">Стандарты и шаблоны</span>
              </span>
            </div>

            {[
              { id: "case-post-1", title: "Кейс: Итоговое письмо", desc: "Пример письма" },
              { id: "tools-post-1", title: "Инструменты: Шаблоны follow-up", desc: "Готовые заготовки" },
            ].map((item) => (
          ...
          <div className="space-y-4">
            <div className="group w-full text-left flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md px-5 py-4 shadow-sm hover:border-white/20 hover:bg-white/10 transition">
              ...
              <span className="flex-1">
                <span className="block text-base md:text-lg font-semibold text-white">Демо-урок (архив): Ретроспектива встречи</span>
                <span className="block text-sm text-white/70">Материалы прошлых спринтов</span>
              </span>
            </div>

            {[
              { id: "2024-08-post", title: "Август 2024: Резюме беседы", desc: "Архивный урок" },
              { id: "2024-04-post", title: "Апрель 2024: Последующие шаги", desc: "Архивный урок" },
            ].map((item) => (
